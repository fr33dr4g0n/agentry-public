  ...
  it("registers the v0 tool set", async () => {
    ...
    expect(names).toEqual(
      [
        ...
        "agentry_configure_session_replay",
        "agentry_create_ab_test",
        ...
        "agentry_session_replay_status",
        "agentry_status",
        "agentry_suggested_next_steps",
        "agentry_survey_responses",
